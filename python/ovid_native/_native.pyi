...
type NativeCommandResult = tuple[str, int | None, bool, bool, int]
...
class NativeCommandConfigurationError(Exception): ...
class NativeCommandPathError(Exception): ...
class NativeCommandExecutionError(Exception): ...
class NativeCommandCancelledError(Exception): ...
class NativeCommandClosedError(Exception): ...


class NativeDiscoveryError(Exception): ...
class NativeDiscoveryConfigurationError(NativeDiscoveryError): ...
class NativeDiscoveryPathError(NativeDiscoveryError): ...
class NativeDiscoveryReadError(NativeDiscoveryError): ...
class NativeDiscoveryEncodingError(NativeDiscoveryReadError): ...
class NativeDiscoveryCancelledError(NativeDiscoveryError): ...
...
class NativeCommandCancellation:
    def __new__(cls) -> NativeCommandCancellation: ...
...
class NativeCommandRequest:
    def __new__(
        ...
        cancellation: NativeCommandCancellation,
    ) -> NativeCommandRequest: ...


class NativeDiscoveryCancellation:
    def __new__(cls) -> NativeDiscoveryCancellation: ...
    def cancel(self) -> None: ...
...
def discovery_find_ancestor_entry(start: str, name: str) -> str | None: ...
def discovery_read_text_files(
    paths: list[str],
    cancellation: NativeDiscoveryCancellation,
) -> list[tuple[str, str]]: ...
def discovery_find_named_files(
    root: str,
    filename: str,
    max_depth: int,
    limit: int,
    timeout_seconds: float,
    cancellation: NativeDiscoveryCancellation,
) -> NativeNamedFileDiscoveryResult: ...
...
def command_execute(workspace: NativeWorkspace, request: NativeCommandRequest) -> NativeCommandResult: ...
